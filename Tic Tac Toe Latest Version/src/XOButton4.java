...
public class XOButton4 extends JButton implements ActionListener {
		ImageIcon X,O;
		int value = 0;
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(ticTacToe.playerDecision == 2 ){
				if(ticTacToe.currentTurn == ticTacToe.CROSS && ticTacToe.board [1][0] == ticTacToe.EMPTY){
					setIcon(X);
				...
				if(ticTacToe.currentTurn == ticTacToe.CIRCLE && ticTacToe.board [1][0] == ticTacToe.EMPTY){
					setIcon(O);
					ticTacToe.currentTurn = ticTacToe.CROSS;
					ticTacToe.board[1][0] = ticTacToe.CIRCLE;
