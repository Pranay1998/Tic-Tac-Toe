...
public class XOButton2 extends JButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(ticTacToe.playerDecision == 2 ){
				if(ticTacToe.currentTurn == ticTacToe.CROSS && ticTacToe.board [0][1] == ticTacToe.EMPTY){
					setIcon(X);
					ticTacToe.currentTurn = ticTacToe.CIRCLE;
					ticTacToe.board [0][1] = ticTacToe.CROSS; 
				...
				if(ticTacToe.currentTurn == ticTacToe.CIRCLE && ticTacToe.board [0][0] == ticTacToe.EMPTY){
					...
					ticTacToe.board[0][1] = ticTacToe.CIRCLE;
